...
<body class="w3-light-grey">
 ...
 <!-- btnListarAdministradores -->
    ...
    <button name="btnListarAdministradores"
            class="w3-button w3-margin w3-blue w3-cell w3-round-large">
        <br> <i class="fa fa-user-circle w3-xxlarge"></i><br>
    ...
    <button name="btnNovoAdministrador"
        class="w3-button w3-margin w3-blue w3-cell w3-round-large">
    <br> <i class="fa fa-user-plus w3-xxlarge"></i><br>
    <p class="w3-xlarge">Novo<br>Administrador</p>
    </button>
 </form>
